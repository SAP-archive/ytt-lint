...
type Importer interface {
	ImportV1(crd apiextensionsv1.CustomResourceDefinition) error
	ImportV1Beta1(crd apiextensionsv1beta1.CustomResourceDefinition) error
}
...
func NewImporter() (Importer, error) {
	...
	metadataTemplateV1 := apiextensionsv1.JSONSchemaProps{}
	err = json.Unmarshal([]byte(metadataTemplateJSON), &metadataTemplateV1)
	if err != nil {
		return nil, fmt.Errorf("json.Unmarshal([]byte(metadataTemplateJSON), &metadataTemplate): %w", err)
	}

	metadataTemplateV1Beta1 := apiextensionsv1beta1.JSONSchemaProps{}
	err = json.Unmarshal([]byte(metadataTemplateJSON), &metadataTemplateV1Beta1)
	if err != nil {
		return nil, fmt.Errorf("json.Unmarshal([]byte(metadataTemplateJSON), &metadataTemplate): %w", err)
	}
	...
	return &importerImpl{
		...
		metadataTemplateV1:      metadataTemplateV1,
		metadataTemplateV1Beta1: metadataTemplateV1Beta1,
	}, nil
}
...
func (importer *importerImpl) ImportV1(crd apiextensionsv1.CustomResourceDefinition) error {
...
func (importer *importerImpl) ImportV1Beta1(crd apiextensionsv1beta1.CustomResourceDefinition) error {
	kind := crd.Spec.Names.Kind
	group := crd.Spec.Group
